...
module.exports = function (app) {
  app.get("/imagecreator/demote", async (req, res) => {
    ...
    try {
      const image = await axios.get(`https://fathurweb.xyz/api/layout?bg=${encodeURIComponent(bg)}&ppuser=${encodeURIComponent(ppuser)}&content=DEMOTE&subtext=${encodeURIComponent(text)}`, {
